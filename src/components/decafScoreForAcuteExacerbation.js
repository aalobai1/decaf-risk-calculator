...
import RiskCalculator2 from './decafScoreComponents/RiskCalc2'
import ToggleButton from './ToggleButton'
import decafScore from './decafScoreComponents/Data'

class DecafScoreForAcuteExacerbation extends React.Component  {
    ...
    render() {
        return (
            <div>
                ...
                calculateDecafScore={this.state.calculateDecafScore}
                />
            </div>
        )
    }
...
export default DecafScoreForAcuteExacerbation;